  ...
  return (
    <>
        ...
        <div className="px-5 py-20 ">
                  ...
                  <div className="flex justify-center items-center gap-2 lg:gap-5 py-5">
                     <button onClick={clickAll} className={all ? 'text-biru' : 'text-gray-600'}>All</button>
                     <button onClick={clickKhitan}  className={khitan ? 'text-biru' : 'text-gray-600'}>Khitan Super Ring</button>
                     <button onClick={clickLuka}  className={luka ? 'text-biru' : 'text-gray-600'}>Rawatan Luka</button>
                  </div>
                           ...
                           filteredNews?.map((value, index) => (
                              ...
                              >
                                 ...
                                 <div className="grow text-black font-light flex flex-col justify-start items-start h-32 overflow-hidden">
                                    <h3 className="text-base h-full break-words max-h-16 font-medium">
                                       {value.title}
                                    </h3>
