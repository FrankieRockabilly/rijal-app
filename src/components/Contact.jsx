        ...
        <>
            <div className='pb-10 pt-28 px-5 lg:px-40'>
                <div className='flex flex-col justify-center items-center gap-6'>
                    <h1 className='text-center text-2xl lg:text-3xl font-bold '>Kontak Kami</h1>
                    <Line />
                </div>
                ...
                <div className='flex flex-wrap shadow-xl bg-white py-2 lg:py-10 mt-5 border'>
                    ...
                    <div className='px-16 py-16 '>
                        ...
                        <div className='w-full'>
                            ...
                            <button type='submit' className={`px-2 py-3 my-5 w-40 bg-biru text-white shadow-2xl shadow-primarySec text-black send ${loading ? 'cursor-not-allowed' : ''}`}>
                    ...
                    <div className='grow w-auto px-5 py-5 flex flex-col justify-start items-start gap-3 text-gray-700 maps'>
                        <div className='flex justify-start items-center gap-3'>
                            ...
                            <p className='break-words text-wrap text-lg'>rizalaraffa14@gmail.com</p>
                        </div>
                        <div className='flex justify-start items-center gap-3'>
                            <div className='px-2 py-2 rounded-full border'>
                                <Phone size={32} weight="thin" />
                            </div>
                            <p className='break-words text-wrap text-lg'>+62 822 7321 2907</p>
                        </div>
                        <div className='flex justify-start items-center gap-3'>
                            <div className='px-2 py-2 rounded-full border'>
